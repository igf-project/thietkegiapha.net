...
// property set value
	...
	public function Add_new(){
		$sql="INSERT INTO `tbl_mnuitem`(`par_id`,`code`,`mnu_id`,`viewtype`,`cata_id`,`cate_id`,`gdoc_id`,`con_id`,`link`,`class`,`isactive`) VALUES ";
		$sql.=" ('".$this->Par_ID."','".$this->Code."','".$this->Mnu_ID."','".$this->Viewtype."','".$this->Cata_ID."','".$this->Cate_ID."','".$this->Gdoc_ID."','".$this->Con_ID."','".$this->Link."','".$this->Class."','".$this->isActive."') ";
