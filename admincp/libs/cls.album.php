...
class CLS_ALBUM{
	...
	function Add_new(){
		$sql=" INSERT INTO `tbl_album`(`name`,`thumb`,`intro`,`isactive`) VALUES";
		$sql.="(N'".$this->Name."','".$this->IMG."',N'".$this->Intro."','".$this->isActive."')";
		return $this->objmysql->Exec($sql);
	}
	function Update(){
		$sql = "UPDATE tbl_album SET `thumb`='".$this->IMG."',`name`=N'".$this->Name."',`intro`=N'".$this->Intro."',`isactive`='".$this->pro["isActive"]."' WHERE id='".$this->ID."'";
		return $this->objmysql->Exec($sql);
	}
