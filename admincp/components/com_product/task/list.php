...
if($key_catalog!='')
    $strwhere.=" AND cata_id ='$key_catalog'";
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Header_list">
        <tr>
          <td><strong>Tìm kiếm:</strong>
            ...
            Nhóm SP:
            <select name="key_catalog" onchange="document.frm_list.submit();">
...
<table class="table table-bordered">
    <tr class="header">
        ...
        <th align="center" width="90">Lượt xem</th>
        <th width="50" align="center">Sắp xếp
